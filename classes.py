...
import openai
from langchain_community.llms import HuggingFaceHub # Moved
#from langchain_community.chains import LLMChain               # Moved
#from langchain.prompts import PromptTemplate         # Moved
